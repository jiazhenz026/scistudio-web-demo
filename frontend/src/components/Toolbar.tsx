    ...
    <TooltipProvider delayDuration={300}>
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-2">
          {/* Public WebMCP demo: the on-page WebMCP status indicator was removed
              (owner request) — it crowded the toolbar. The status still updates
              in `webmcp/badge.ts`; nothing renders it. */}
          {/*
          ...
          {/* Public WebMCP demo: "Bring in my work" is removed — it imports an
           * existing local analysis into the project, which the ChatGPT-driven
           * demo has no use for. */}
